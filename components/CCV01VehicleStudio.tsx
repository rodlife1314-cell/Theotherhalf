      ...
      <div className="bg-slate-900 border border-slate-800 rounded-xl p-4 shadow-xl">
        <div className="flex flex-wrap items-center justify-between gap-3 pb-3 border-b border-slate-800">
          ...
          <div className="flex items-center gap-2 flex-wrap">
            {onNavigateToPathfinder && (
              <button
                id="btn-ccv-goto-pathfinder"
                onClick={onNavigateToPathfinder}
                className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg bg-indigo-500/20 hover:bg-indigo-500/30 text-indigo-300 border border-indigo-500/40 text-xs font-mono font-medium transition-colors"
              >
                <Compass className="w-3.5 h-3.5 text-amber-400" />
                <span>Pathfinder Cortex</span>
              </button>
            )}
            {onOpenAiSynthesis && (
              <button
